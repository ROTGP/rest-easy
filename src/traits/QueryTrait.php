...
{  
    ...
    /** 
     * // @TODO 
     * Add optionional scopeQuery(), which, if defined,
     * is applied implicitly, and accepts the current
     * builder, as well as authUser, and request payload
    */
